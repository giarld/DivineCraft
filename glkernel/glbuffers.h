...
struct VertexDescription
{
    enum
    {
        Null = 0, // Terminates a VertexDescription array       终止VertexDescription数组
        Position,
        TexCoord,
        Normal,
        Color,
    ...
    int count; // number of elements            元素的数目
    int offset; // field's offset into vertex struct        顶点结构的字段描述
    int index; // 0 (unused at the moment) 0则未使用
};
